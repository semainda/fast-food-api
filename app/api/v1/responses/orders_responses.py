...
class PostResponse:
    ...
    def post_order_with_invalid_item_type_and_value_response(self):
        """Method for creating order with invalid item response"""
        return {
            "Message": "Invalid Order Item",
            "Description": "Order can not be created",
            "Status": "BAD REQUEST"}, 400

    def post_order_with_invalid_description_type_and_value_response(self):
        """Method for posting order with invalid description response"""
        return {
...
class PutRespose:
    ...
    def put_order_with_invalid_status_response(self):
        """Method for updating order with invalid status response"""
        return {
